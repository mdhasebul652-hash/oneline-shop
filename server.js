...
<label style="font-size:13px;">Choose Product (Order Now link):</label><br>
<select name="productId" style="width:100%; padding:8px; margin:3px 0 10px 0; border:1px solid #ccc; border-radius:4px;">
<option value="">-- কোনো Product না --</option>
...
const savedName = `${Date.now()}-fb-${safeName}`;
fs.writeFileSync(path.join(uploadDir, savedName), req.file.buffer);
await new FbContent({
